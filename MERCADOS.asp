...
var auto=0;
var url = '../MERCADOS.asp?pos='
var alias = '"&OWNER&".MERCADOS'
var TBL = '"&OWNER&".MERCADOS'
var PK  = 'CODIGO'
var DS  = 'descripcion'
var largo=4
var oldrow=1
...
'*********************************************
Dim urlBase
urlBase = "MERCADOS.asp"
'*********************************************
' Definir el TITULO de la PAGINA ASP 
'*********************************************
Dim TITULO
TITULO = "MERCADO DE VENTA"
%>
<script>
// **************************************************************
	...
	<tr>
		...
		<td >
			<IMG SRC="IMAGENES/PREV.GIF" ALT="PAGINA ANTERIOR"
				onclick="atras('"&OWNER&".MERCADOS', '<%=indice%>')" 
				STYLE="CURSOR:HAND"> 
		</td>
		<td >
		 ...
		 bordercolorlight=GAINSBORO bordercolordark=WHITE>
            ...
            <td BGCOLOR=WHITE WIDTH=20% valign=middle> 
              <input type="text" id="COD" name="COD" 
				STYLE="WIDTH:70%" valign=middle
				TABINDEX=-1 READONLY maxlength=4>&nbsp;
...
<tr>
	...
	<td>		
		<IMG SRC="imagenes/PRINT.gif" ALT="IMPRESION"
			onclick="javascript: window.open('REPORTES/prnTBL.asp?pk=CODIGO&ds=DESCRIPCION&tbl="&OWNER&".MERCADOS&tit=MERCADO DE VENTA')"
			style="cursor:hand;">	
	</td>				
	<td>		
