...
var auto=0;
var pre = 'M'
var pref = 'LINEAPRENDAS'
var url = '../LINEAPRENDAS.asp?POS='
var alias = '"&OWNER&".LINEAPRENDAS'
var tipo = 'codigo'
var TBL = '"&OWNER&".LINEAPRENDAS'
var PK = 'CODLINEA'
var DS = 'DESCRIPCION'
var oldrow =1
var largo = 3
...
'*********************************************
Dim urlBase
urlBase = "LINEAPRENDAS.asp"
'*********************************************
' Definir el TITULO de la PAGINA ASP 
'*********************************************
Dim TITULO
TITULO = "LINEAS DE PRENDA"
%>
<script>
// **************************************************************
...
<table border=0 align=center  cellspacing=5>
	<tr>
		...
		<td >
			<IMG SRC="IMAGENES/PREV.GIF" ALT="PAGINA ANTERIOR"
				onclick="atras('[lineaprendas]', '<%=indice%>', 'M')" 
				STYLE="CURSOR:HAND"> 
		</td>
		<td >
	...
	<td>		
		<IMG SRC="imagenes/PRINT.gif" ALT="IMPRESION"
			onclick="javascript: window.open('REPORTES/prnTBL.asp?pk=CODIGO&ds=DESCRIPCION&tbl=[lineaprendas]&tit=LINEAS DE PRENDA')"
			style="cursor:hand;">	
	</td>	
	</tr>
</table>
...
<TR><TD>
        <table	align=center width="100%" cellpadding=1 cellspacing=0  bgcolor=WHITE border=1
		 bordercolorlight=GAINSBORO bordercolordark=WHITE>
            ...
            <td BGCOLOR=WHITE WIDTH=20% valign=middle> 
              <input type="text" id="COD" name="COD" 
				STYLE="WIDTH:70%" valign=middle MAXLENGTH=3
				TABINDEX=-1 READONLY >&nbsp;
