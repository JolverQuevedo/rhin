...
/********************************
 function FComARE(nTotal)
********************************
var cStr := "", nInt
// millones
nInT := int(nTotal/1000000)
if nInt > 0
   if nInt == 1
      cStr := 'ONE MILLION '
   else
      cStr := cStr+FCommil1(nInt)+' MILLIONS '
   end
   nTotal  := nTotal-nInt*1000000
end
nInt:=int(nTotal)
if nInt > 0
   cStr+=FCommil1(nInt)+' AND '
   nTotal := nTotal-nInt
end
nTotal=nTotal*100
cStr+=FormatNumber(nTotal,2,false,false,true,true)+'/100 '
return cStr
*********************************
 function FCommil1(nTotal)
*********************************
var cStr := "", nInt
nInt := Int(nTotal/1000)
if nInt > 0
   if nInt == 1
      cStr+='ONE THOUSAND '
   else if nInt == 21
      cStr+='TWENTY THOUSAND '
   else
      cStr+=cStr + FComcien1(nInt) + ' THOUSAND '
   end
   nTotal := nTotal - nInt * 1000
end
nInt := nTotal
...
if nInt > 0
   if nInt == 1
      ...
      cStr := cStr + FComunid1(nInt) + 'HUNDRED '
   end
   nTotal := nTotal - nInt * 100
end
nInt := nTotal
if nInt<=20
   if nInt = 0
      ...
      return cStr + 'THIRTEEN'
   else if nInt == 14
      return cStr + 'FOURTEEN'
   else if nInt == 15
      return cStr + 'FifTEEN'
   else
      return cStr + FComUNID1(nInt-10) + 'TEEN'
   end
end
nInt := Int(nTotal/10)
if nInt == 2
...
return cStr+FComunid1(nTotal)
/*************************************
  function FComunid1(nTotal)
/*************************************
{	if (nTotal == 2)
	   return 'TWO'
	else if nTotal == 3
