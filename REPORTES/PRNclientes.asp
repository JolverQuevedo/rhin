...
CAD =	" SELECT  " & _
		" "&tbl&".CLIENTE, "&tbl&".NOMBRE, "&tbl&".DIRECCION, " & _
		" "&tbl&".CIUDAD, "&tbl&".PAIS, "&tbl&".TELEFONO, "&tbl&".FAX " & _
		" from "&tbl&" " & _
		" where "&tbl&".ESTADO = 'A' " & _ 
		" ORDER BY "&tbl&".CLIENTE " 
		RS.OPEN CAD ,Cnn
	'response.Write (cad	)
If rs.eof or rs.bof then
	Response.Write("Maestro de Hilos Vacío")		
	Response.End
end if	
