...
<tr class="BARRA333" valign="top" align="center"  style="background-color:#FFF;">
    <td colspan="6"></td>
    <td colspan="13" align="center">P E D I D O&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 100%</td>
    <td colspan="13" align="center">C O R T E&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;105%</td>
    <td colspan="17" align="center">T E L A &nbsp;&nbsp;&nbsp;&nbsp;P R I N C I P A L &nbsp;&nbsp;&nbsp;&nbsp;105%</td>
    <%for i=2 to 10 %>
     <td colspan="17" align="center">T E L A &nbsp;&nbsp;&nbsp;&nbsp;<%=i%> &nbsp;&nbsp;&nbsp;&nbsp;105%</td>
     <%next%>
</tr>
...
<%DO WHILE NOT RS.EOF %>
	<tr valign="top"   style="background-color:#FFF;">
        ...
        for K= 1 TO 10 %>
            ...
            IF  ISNULL(RS(CON))  THEN  KILO = "" ELSE KILO = FORMATNUMBER(CDBL(RS(CON))/1000,3,,,TRUE) 
