...
var auto=0;
var url = '../PAISES.asp?pos='
var alias = '"&OWNER&".paises'
var TBL = '"&OWNER&".PAISES'
var PK  = 'CODIGO'
var DS  = 'desCRIPCION'
var largo=3
var oldrow=1
	...
	<tr>
		...
		<td >
			<IMG SRC="IMAGENES/PREV.GIF" ALT="PAGINA ANTERIOR"
				onclick="atras('TEMPORADAS', '<%=indice%>')" 
				STYLE="CURSOR:HAND"> 
		</td>
		<td >
...
<TR><TD>
		...
		cellpadding=1 cellspacing=0    border=1 bordercolorlight=gainsboro bordercolordark=white>
          <tr valign="middle"> 
            ...
            <td BGCOLOR=WHITE WIDTH=10% valign=middle> 
              <input type="text" id="COD" name="COD" 
				class=datosgrande valign=middle MAXLENGTH=3
				TABINDEX=-1 READONLY>&nbsp;
...
<tr>
	...
	<td>		
		<IMG SRC="imagenes/PRINT.gif" ALT="IMPRESION"
			onclick="javascript: window.open('REPORTES/prnTBL.asp?pk=CODIGO&ds=desCRIPCION&tbl=PAISES&tit=PAISES')"
			style="cursor:hand;">	
	</td>				
	<td>		
