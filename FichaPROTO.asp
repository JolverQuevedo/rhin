...
<%Set RS2 = Server.CreateObject("ADODB.Recordset")
	...
	CAD =	" exec FICHAPROTO '"&PRO&"' , '"&VER&"', '"&CLI&"'  " 
...
'	response.Write(cAD)
	...
	IF RS("pro")= "AUTO" THEN
	    marka = 0	
		titulo = "NUEVA FICHA DE CONSUMOS"
	else
	    marka = 1
		titulo = "HOJA DE CONSUMO # " + trim(rs("PRO"))+ " -> " + trim(rs("VER"))
	END IF%>
...
<form id="thisForm" method="post" name="thisForm" action="comun/inserFICHAPROTO.asp">
...
<table border="1" cellpadding="2" width="100%" cellspacing="0" bgcolor="<%=(Application("color2"))%>" bordercolordark="<%=(Application("borde"))%>" bordercolorlight="<%=(Application("COLOR1"))%>">
    <tr valign="middle">
        <td align="left" bgcolor="<%=(Application("BARRA"))%>" colspan="2" class="TITULITO"># PROTO:</td>
        <td align="left" ><input type="text" id="PRO" name="PRO" value=
	        "<%=rs("PRO")%>" tabindex="-1" readonly="readonly" class="BARRAS" style="width:100%" />    </td>
	    ...
	    <td align="left"  width="10%" rowspan="8" valign="top"><img src="imagenes/ESTILO.JPG" width="150" ID="FOT" /></td>   
    </tr>
    <tr valign="middle">
        <td align="left" bgcolor="<%=(Application("BARRA"))%>" width="5%"  class="TITULITO">ESTILO</td>
         <td width="1%"  bgcolor="<%=(Application("BARRA"))%>"><img src="imagenes/help.gif" border="0" id="estilocli" onClick="help('DETAESTILO.asp?POS=<%=RS("CLI")%>&HLP=1')" alt="" /></td>
        <td align="left"><input type="text" id="EST" name="EST" value=
	        "<%=rs("EST")%>" tabindex="-1" readonly="readonly" class="BARRAS" style="width:100%" />    </td>
	    <td align="left" colspan="2" bgcolor="<%=(Application("BARRA"))%>"><input type="text" id="ECL" name="ECL" value="<%=rs("ECL")%>" 
	        tabindex="-1" readonly="readonly" class="barras"/></td>
	    <td align="left" colspan="4" bgcolor="<%=(Application("BARRA"))%>"><input type="text" id="DESE" name="DESE" value="<%=rs("DES")%>" 
	         class="BARRAw3" maxlength="200" /></td>  
    </tr>
    <tr valign="middle">
     ...
     <tr valign="middle">
        <td align="left" bgcolor="<%=(Application("BARRA"))%>" width="5%"  class="TITULITO" colspan="2">Observaciones:</td>
         <td align="left" colspan="6"><input type="text" id="OBSE" name="OBSE" value=
	        "<%=rs("ADIC")%>"  class="BARRAw3"  />  
         </tr>
     ...
     <tr valign="middle">
        <td align="left" bgcolor="<%=(Application("BARRA"))%>" width="5%"  class="TITULITO">TEMPORADA :</td>
         <td width="1%" bgcolor="<%=(Application("BARRA"))%>"><img src="imagenes/help.gif" border="0" onClick="help('HELP/HLPTEMPO.asp?POS=<%=RS("CLI")%>')" alt="" id="ttt"/></td>
        <td align="left"><input type="text" id="TEM" name="TEM" value=
	        "<%=rs("TEM")%>" tabindex="-1" readonly="readonly" class="BARRAS"/>    </td>
	    <td align="left" colspan="2"  bgcolor="<%=(Application("BARRA"))%>"><input type="text" id="DTEM" name="DTEM" value="<%=rs("DTEM")%>" 
	        tabindex="-1" readonly="readonly" class="barras"  /></td>
	    <td align="left" bgcolor="<%=(Application("BARRA"))%>" width="5%"  class="TITULITO">&nbsp;GRUPO 
            TELA :</td>     
	    <td align="left" colspan="3"><input type="text" id="MOT" name="MOT" value="<%=rs("MOT")%>" 
	        maxlength="100" class="BARRAw3" /></td>  
    </tr>
   <tr valign="middle">
     <td align="left" bgcolor="<%=(Application("BARRA"))%>" width="5%"  class="TITULITO">TELA :</td>
     <td width="1%" bgcolor="<%=(Application("BARRA"))%>"><img src="imagenes/help.gif" border="0" onClick="help('help/hlpfamtelas.asp?HLP=1')" alt="" id="www"/></td>
     <td align="left"><input type="text" id="TELA" name="TELA" value="<%=rs("TEL")%>"  class="datoskhaki" onchange="bake(1, this.value, '')" />    </td>
   ...
   <tr valign="middle">
    ...
    <tr valign="middle" >
         <td align="left" bgcolor="<%=(Application("BARRA"))%>" width="5%"  class="TITULITO">TALLAS :</td>
         <td width="1%" bgcolor="<%=(Application("BARRA"))%>"><img src="imagenes/help.gif" border="0" onClick="help('HELP/HLPTALLAS.asp?POS=<%=RS("CLI")%>' +'&maxi=10')" alt="" id="ooo" /></td>
    <td colspan="7" WIDTH="90%" bgcolor="<%=(Application("BARRA"))%>">
        <table width="100%" align="center" border="0" cellpadding="0" cellspacing="0"  >
          <tr id="TALLAS">
            ...
            <%NEXT%>
              <%RS2.OPEN "SELECT TALLA,PROP, orden FROM [PROTO-TALLAS] WHERE PROTO = '"&PRO&"' AND VERSION = '"&VER&"' ORDER BY ORDEN", CNN 
...
<table border="1" cellpadding="2" width="100%" cellspacing="0" bgcolor="<%=(Application("color2"))%>" bordercolordark="<%=(Application("borde"))%>" bordercolorlight="<%=(Application("COLOR1"))%>">
    <tr valign="middle" bgcolor="<%=(Application("BARRA"))%>">
        <td align="left" class="TEXTOmicro" width="1%"><img src="imagenes/dele.jpg" alt="BORRAR LINEA" border="0"></td>
    ...
    <%CAD =	" exec FICHAPROTO_TELA '"&PRO&"' , '"&VER&"'  "  
    'RS.CLOSE
    'response.write(cad)
    RS2.OPEN CAD,CNN%>
    <% RS2.MOVEFIRST%>
	...
	<%DO WHILE NOT RS2.EOF%>
		<tr valign="middle" bgcolor="<%=(Application("color2"))%>" style="display:block" id="FILA<%=i%>" >
            ...
            <td width="6%"><input type="text" id="TEL<%=i%>" name="TEL<%=i%>" value="<%=rs2("tel")%>"  class="DATOSKHAKI" onDblClick="help('help/hlpfamtelas.asp?HLP=2','<%=i%>','tela')" onchange="bake(2,this.value,'<%=i %>')" /></td>
...
<table align="center" border="0" cellpadding="10" id="botones"> 
    <tr>
        <td id="grab"><img id="Img1" alt="GRABA CAMBIOS" style="cursor:pointer; " onClick="graba(1)" src="imagenes/disk.gif" /></td>
        <td><img id="Img2" alt="NUEVA VERSION" style="cursor:pointer;" onClick="graba(2)" src="imagenes/VERSION.JPG" /></td>
        <td><img id="Img3" alt="NUEVO PROTO VERSION" style="cursor:pointer;" onClick="graba(3)" src="imagenes/PROTOVER.JPG" /></td>
    </tr>
</table>
...
ggr = '<%=rs("coti")%>'
if (ggr.length > 0) {
    document.all.grab.style.display = 'none';
    document.all.estilocli.style.display = 'none';
}

else
    document.all.estilocli.style.display = 'block'
...
if (parseInt(op,10) >= 2)
    document.all.VER.value = 'AUTO'

if (parseInt(op,10) == 3) 
    document.all.PRO.value = 'AUTO'

//alert(op)
thisForm.action='comun/inserFichaProto.asp?telm='+tope+'&avim='+maxi+'&op=' + op
thisForm.submit()
