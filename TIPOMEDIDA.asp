...
var auto=1;
var url = '../TIPOMEDIDA.asp?pos='
var alias = 'dbo.TIPOMEDIDA'
var TBL = 'dbo.TIPOMEDIDA'
var PK  = 'CODIGO'
var DS  = 'desCRIPCION'
var largo = 3
var largo2 = 200
...
<tr>
	<td > 
		<IMG SRC="imagenes/SEARCH.gif" ALT="BUSCAR"
			...
			'TIPO', 'desCRIPCION')" 
			ALT="BUSCA" style="cursor:pointer;"> 
	</td>
	<td>
	...
	<td>		
		<IMG SRC="imagenes/PRINT.gif" ALT="IMPRESION"
			onclick="javascript:window.open('REPORTES/prnTBL.asp?pk=CODIGO&ds=desCRIPCION&tbl=DBO.TIPOMEDIDA&tit=TIPOS DE MEDIDAS')"
			style="cursor:pointer;">	
	</td>				
	<td>		
