...
var auto=1;
var url = '../TEJEDORAS.asp?'
var alias = 'VIEW_TEJEDORAS'
var TBL = 'TEJEDORAS'
var PK  = 'CODIGO'
var DS  = 'DESTEJ' 
...
Dim TITULO
TITULO = "PARQUE DE MAQUINAS PARA TEJEDURIA"
%>
<script type="text/jscript" language="jscript">
// **************************************************************
//  Indicar el nombre de la página donde se realizan los cambios 
// **************************************************************
var funcionalidad = 'comun/INSERTEJEDORAS.asp?'
...
<form name="thisForm" id="thisForm" method="post" action='<%=URLBASE %>'>
...
<!--#include file="COMUN/COMUNTEJEDORAS.ASP"-->
...
'******************************************************************************************
'TENEMOS QUE HACER UN VIEW PARA MOSTRAR LOS DATOS......................
'******************************************************************************************
    ...
    <tr  bgcolor="<% if CONT mod 2  = 0 THEN 
	    ...
	    <%for i=0 to LIMITE%>
		    <td>
			    ...
			    <b><%=trim(RS.FIELDS.ITEM(I))%></b>&nbsp;</font>
		    </td>
	    <%NEXT%>	
   		...
   		<td>
            ...
            cellpadding="1" cellspacing="0"  bgcolor="WHITE" border="1" >
              <tr valign="middle"  bgcolor="<%=(Application("barra"))%>"> 
                ...
                <td bgcolor="<%=(Application("color2"))%>" width="10%" valign="middle"> 
                  <input type="text" id="COD" name="COD"  class="DATOSGRANDE" style="width:100%"
              ...
              <tr>
                <td width="10%" align="RIGHT"  bgcolor="<%=(Application("barra"))%>"> <font face="arial" size="1" color="#000066"><b> 
                  TIPO :</b></font> 
                </td>
                   ...
                   <select id="TIPO" style="width:100%" name="TIPO">
                       <option></option>
				        ...
				        <%if rs2.recordcount <=0 then%>
                       		 <option value=''>No Hay Marcas de Máquinas de Tejeduría Registradas </option>
                        <%else%>
							<%rs2.movefirst%>
              ...
              <td width="10%" align="RIGHT"  bgcolor="<%=(Application("barra"))%>"> <font face="arial" size="1" color="#000066"><b> 
                ...
                <td bgcolor="<%=(Application("color2"))%>" WIDTH="15%"> 
                   <select id="MARCA" style="width:100%" name="MARCA">
                       <option></option>
                        <%RS2.CLOSE
                        CAD = "SELECT * FROM MARCATEJ WHERE ESTADO = 'A' ORDER BY descripcion "
				        RS2.OPEN CAD, Cnn %>
				        <%if rs2.recordcount <=0 then%>
                       		 <option value=''>No Hay Marcas de Máquinas Registradas </option>
                        <%else%>
							<%rs2.movefirst%>
                            <%do while not rs2.eof%>
                                    <option value=<%=rs2("CODIGO")%>><%=rs2("DESCRIpcion")%> </option>
                ...
                <td bgcolor="<%=(Application("color2"))%>" width="15%"> 
                   <select id="MODELO" style="width:100%" name="MODELO">
                       <option></option>
                        <%RS2.CLOSE
                        CAD = "SELECT * FROM MODMAQ WHERE ESTADO = 'A' ORDER BY descripcion "
				        RS2.OPEN CAD, Cnn %>
				        <%if rs2.recordcount <=0 then%>
                       		 <option value=''>No Hay Modelos de Máquinas de Tejeduría Registradas </option>
                        <%else%>
							<%rs2.movefirst%>
                            <%do while not rs2.eof%>
                                    <option value=<%=rs2("CODIGO")%>><%=rs2("DESCRIpcion")%> </option>
                ...
                <td bgcolor="<%=(Application("color2"))%>" width="15%" valign="middle" width="15%"> 
                  <input type="text" id="GALGA" name="GALGA"  style="width:100%" class="DATOSGRANDE" />
                </td>
            </tr>
              <tr>    
                <td width="10%" align="RIGHT"  bgcolor="<%=(Application("barra"))%>"> <font face="arial" size="1" color="#000066"><b> 
                ...
                <td bgcolor="<%=(Application("color2"))%>" width="15%" valign="middle"> 
                  <input type="text" id="AGUJAS" name="AGUJAS" style="width:100%" class="DATOSGRANDE" />
                </td>
              ...
              <td width="10%" align="RIGHT"  bgcolor="<%=(Application("barra"))%>"> <font face="arial" size="1" color="#000066"><b> 
                ...
                <td bgcolor="<%=(Application("color2"))%>" width="15%" valign="middle"> 
                  <input type="text" id="DIAMETRO" name="DIAMETRO" style="width:100%" class="DATOSGRANDE" />
                </td>
                 <td width="10%" align="RIGHT"  bgcolor="<%=(Application("barra"))%>"> <font face="arial" size="1" color="#000066"><b> 
                  ALIMENTADORES :</b></font> 
                </td>
                 </td>
                <td bgcolor="<%=(Application("color2"))%>" width="15%" valign="middle"> 
                  <input type="text" id="ALIMENTA" name="ALIMENTA" style="width:100%" class="DATOSGRANDE" />
                </td>
              <td width="10%" align="RIGHT"  bgcolor="<%=(Application("barra"))%>"> <font face="arial" size="1" color="#000066"><b> 
                  SISTEMAS :</b></font> 
                </td>
                ...
                <td bgcolor="<%=(Application("color2"))%>" width="15%" valign="middle"> 
                  <input type="text" id="SISTEMAS" name="SISTEMAS" style="width:100%" class="DATOSGRANDE" />
                </td>
        ...
        <td>
            <table border="0" align="center"  cellspacing="3">
                <tr>
                    ...
                    <%IF SINDATOS = "1" THEN%>	
                     <td>		
                        <img src="imagenes/copia.jpg" alt="CLONAR REGISTRO"
                            onclick="COPIADOR()" style="cursor:hand;" />	
                    </td>		
                    <%END IF %>
                </tr>
            </table>
