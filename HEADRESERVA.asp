...
<tr>
	<td align= left WIDTH=35% ROWSPAN=2>
		...
		style="cursor:hand;"
		onclick="javascript: top.window.location.replace('SUBMENU.ASP?TIPO=15');">
	</td>
	<td align= CENTER>
		<font face=arial size= 3 color=DarkBlue><B>RESERVAS POR CLIENTE
		</b></font>
	</td>
...
<SCRIPT>
function ENVIO()
{	cad = 'detaRESERVA.asp?pos='+trim(thisForm.CLI.value)+'&OFI='+  '""'
	//alert(cad)
