...
<form name="thisForm" id="thisForm" method="post" action="FAMUTIL.asp">
   		...
   		<td>
            ...
            cellpadding="1" cellspacing="0"  bgcolor="WHITE" border="1" >
              <tr valign="middle"> 
                ...
                <td bgcolor="<%=application("color2") %>" width="5%" valign="middle"> 
                  <input type="text" id="COD" name="COD" class="DATOSGRANDE" tabindex="-1" readonly="readonly" />
                </td>
