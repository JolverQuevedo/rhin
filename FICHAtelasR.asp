        ...
        <td bgcolor="#ffffff" align="center">
            <table width="100%" border="1" bordercolordark="DarkOrange" cellpadding="3" cellspacing="0" bordercolorlight="#FFFFFF" > 
                <tr width="100%" height="50px">
	                ...
	                <font color="#000066" size="3" face="arial"><b>Registro de Telas</b></font> </td>
                </tr>
            </table>
		</td>	
...
<table  border="0" cellspacing="2" cellpadding="4" align="center" class="Estilo55" >
  ...
  <tr>
         ...
         <td><input type="text" class="texto" tabindex="-1" readonly  style="width:100%" id="cta" name="cta" style="text-align:left; width:100%" value="<%if trim(rs2("ar_ccuenta"))= "" then response.write("241103") else response.write(rs2("AR_CCUENTA"))%>"/></td>
  ...
  <tr>
        ...
        value="<% if trim(rs2("ar_cmodelo"))= "" then response.write("TELAS - RHIN TELAS") else response.write(rs2("AR_CMODELO")+" Rhin" )%>"/></td>    
  </tr>
</table>
</td></tr>
<!--------------------------------------------------------------------->
