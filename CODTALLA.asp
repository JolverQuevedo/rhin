...
<!--#include file="COMUN/COMUNtAl.ASP"-->
<%	RS.Open CAD, Cnn
    SINDATOS =1
	CONT = 1
...
<table	align="center" border="0" id="DATAENTRY"  style="display:none;">
   <tr>
   		<td>
