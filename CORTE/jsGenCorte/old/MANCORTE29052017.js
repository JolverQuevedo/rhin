						...
						if(data.status==1)
							...
							for(i=1;i<=$('#tbTallas tr').length-2;i++)
								{ 	
									...
									$.getJSON('http://192.168.3.5/webservice/GrabaManCorteDetFox.asp?CD_CNROOFI='+CD_CNROOFI+'&CD_CNROCORTE='+CD_CNROCORTE+'&CD_CSECUEN='+CD_CSECUEN+'&CD_CARTICULO='+CD_CARTICULO+'&CD_CTALLA='+CD_CTALLA+'&CD_NCANT='+CD_NCANT+'&CD_NINI='+CD_NINI+'&CD_NFIN='+CD_NFIN+'&CD_NORDEN='+CD_NORDEN+'&tabs='+_x+'&item='+i+'&paqt='+nropaquete,function(data){
									})
									.done(function(data)
										{
										if(data.status==1)
