...
$(document).ready(function(){
	...
	function GeneraControles(titulo,id)
	{
		...
		var _html = '';
		 ...
		 _html += '<td><input type="text" name="txtCorteN'+id+'" id="txtCorteN'+id+'" style="'+_estilo+'" size="10" maxlength="5"></td>';
		 _html += '<td>&nbsp;</td>';
		 _html += '<td>&nbsp;</td>';
		 _html += '<td>&nbsp;</td>';
		 _html += '<td>&nbsp;</td>';
		 ...
		 _html += '     <td><input type="text" name="txtPano'+id+'" id="txtPano'+id+'" style="'+_estilo+'" size="10" value="0"></td>';
		 _html += '     <td class="fondocelda">Tapeta</td>';
		 _html += '    <td><input type="text" name="txtTapeta'+id+'" id="txtTapeta'+id+'" style="'+_estilo+'" size="10" value="0"></td>';
		 _html += '   </tr>';
		 _html += '   <tr>';
		 _html += '     <td class="fondocelda">Cons. Estimado</td>';
		 _html += '     <td><input type="text" name="txtEstimado'+id+'" id="txtEstimado'+id+'" style="'+_estilo+'" size="10" value="0"></td>';
		 _html += '     <td class="fondocelda">Pzas x Paño</td>';
		 _html += '     <td><input type="text" name="txtPzaPano'+id+'" id="txtPzaPano'+id+'" style="'+_estilo+'" size="10" value="0"></td>';
		 _html += '     <td class="fondocelda">Retazos</td>';
		 _html += '     <td><input type="text" name="txtRetazos'+id+'" id="txtRetazos'+id+'" style="'+_estilo+'" size="10" value="0"></td>';
		 _html += '   </tr>';
		 _html += '   <tr>';
		 _html += '     <td class="fondocelda">Cons Real</td>';
		 _html += '     <td><input type="text" name="txtReal'+id+'" id="txtReal'+id+'" style="'+_estilo+'" size="10" value="0"></td>';
		 _html += '     <td class="fondocelda">Paños</td>';
		 _html += '     <td><input type="text" name="txtPan'+id+'" id="txtPan'+id+'" style="'+_estilo+'" size="10" value="0"></td>';
		 _html += '     <td class="fondocelda">Puntas</td>';
		 _html += '    <td><input type="text" name="txtPuntas'+id+'" id="txtPuntas'+id+'" style="'+_estilo+'" size="10" value="0"></td>';
		 _html += '   </tr>';
		 _html += '   <tr>';
		 _html += '     <td class="fondocelda">Ancho</td>';
		 _html += '     <td><input type="text" name="txtAncho'+id+'" id="txtAncho'+id+'" style="'+_estilo+'" size="10" value="0"></td>';
		 _html += '     <td class="fondocelda">Kg</td>';
		 _html += '     <td><input type="text" name="txtKg'+id+'" id="txtKg'+id+'" style="'+_estilo+'" size="10" value="0"></td>';
		 _html += '     <td class="fondocelda">Fallados</td>';
		 _html += '     <td><input type="text" name="txtFalla'+id+'" id="txtFalla'+id+'" style="'+_estilo+'" size="10" value="0"></td>';
		 _html += '   </tr>';
		 _html += '   <tr>';
		 _html += '     <td class="fondocelda">Larg Tend</td>';
		 _html += '    <td><input type="text" name="txtLarg'+id+'" id="txtLarg'+id+'" style="'+_estilo+'" size="10" value="0"></td>';
		 _html += '     <td class="fondocelda">Sobrantes</td>';
		 _html += '     <td><input type="text" name="txtSobrantes'+id+'" id="txtSobrantes'+id+'" style="'+_estilo+'" size="10" value="0"></td>';
		 _html += '     <td class="fondocelda">Partida</td>';
		 _html += '     <td><input type="text" name="txtPartida'+id+'" id="txtPartida'+id+'" style="'+_estilo+'" size="10" value="0"></td>';
		 _html += '   </tr>';
		 _html += '   <tr>';
		 _html += '     <td><p>&nbsp;</p></td>';
		 _html += '     <td>&nbsp;</td>';
		 ...
		 _html += '     <td><input type="text" name="txtMetros'+id+'" id="txtMetros'+id+'" style="'+_estilo+'" size="10" value="0"></td>';
		 _html += '   </tr>';
		 _html += '   <tr>';
		 ...
		 _html += '     </select>';
		 _html += '     </td>';
		 _html += '     <td colspan="2" style="font-size:12px;">Paquete de <input type="text" name="txtPaquete'+id+'" id="txtPaquete'+id+'" size="5" style="'+_estilo+'" value="0">Piezas';
		 _html += '     </td>';
		 _html += '   </tr>';
		 _html += '   <tr>';
			...
			if(value!='')
				{
					...
					$('#txtCan'+id+fil).keyup(function(e){
						//alert('sss');
						//var _pqt = parseInt($('#txtPaquete'+id).val());
						//if(_pqt<=0)
						//	alert($('#txtPaquete'+id).val());
						if($.trim($('#txtPaquete'+id).val())=="")
						{
							alert('Debe ingresar cantidad de Paquete!!');
							return;
						}
	...
	function fBuscaCorte(_text,id)
	{
		...
		.done(function(data){
			...
			if(data[0].CT_CNROCORTE!='')
				{
					alert('El Corte Ingresado ya existe, Ingrese otro numero');
				}
			else{
				$('#txtFecha'+id).focus();
			}
	...
	function fBuscar()
	{
		...
		.done(function(data){ 
			...
			$.getJSON('../corte/sqlGenCorte/ListaPoColores.asp?do_ccodigo=' + data[0].CO_CCODIGO+'&opc=1', 			function(data) {
					i = 0;
		    		$.each(data, function(k,v){
$('#tbPo tr:last').after('<tr class="fila" id="fil'+i+'"><td id="celcolor'+i+'">'+v.do_cdescol1+'</td><td id="celdescolor'+i+'">'+v.do_cdescol2+'</td></tr>');	
...
$('#tbColores tr:last').after('<tr class="fila" id="fila'+x+'"><td><input type="checkbox" id="'+d.do_ccodcol1+'" /></td><td id="f'+$.trim(d.do_ccodcol1)+'">'+$.trim(d.do_cdescol1)+'</td></tr>');	
		...
		$("input:checkbox:checked").each(function() {
			...
			$('#txtKg'+ind).keyup(function(e){
				if($(this).val()>0)
				{
					...
					var n = $(this).attr('id');
					n = n.substring(5,19); 
					for(i=1;i<=$('#tbTallas'+n+' tr').length-1;i++)
						{
						if($.trim($('#txtCan'+n+i).val())!="")
							{
								_real = _real+parseFloat($('#txtCan'+n+i).val());
							}
						}
					_tot = (parseFloat($('#txtKg'+n).val())/_real).toFixed(3);  
					//$('#txtReal'+n).val(_tot);
			...
			$('#txtTapeta'+ind).keyup(function(e){
			if($(this).val()>0)
				{
					_real = 0;
					_tot  = 0;
			...
			$('#txtRetazos'+ind).keyup(function(e){
			if($(this).val()>0)
				{
					_real = 0;
					_tot  = 0;
			...
			$('#txtPuntas'+ind).keyup(function(e){
			if($(this).val()>0)
				{
					_real = 0;
					_tot  = 0;
	...
	{	
		...
		//alert($.trim($('#cboArticulo').val()));
		if($.trim($('#cboArticulo').val())=='')
			{
			...
			if(confirm('¿Seguro de generar planillas y cortes?'))
			{
				...
				$("input:checkbox:checked").each(function() 
				{
					...
					.done(function(data){
						...
						{
							var _x     = data.tabs;
							var _col   = data.tabs-1;
							var _color = $('#fila'+_col).find("td").eq(1).text();
							_color     = _color.split(' ');
								
								//alert(codColor+'/'+desColor);
								//$("input:checkbox:checked").each(function() {
							...
							for(i=1;i<=$('#tbTallas'+_x+' tr').length-2;i++)
								{ 	
									...
									//window.open('../corte/sqlGenCorte/GrabaCorteDet.asp?nroOFI='+CD_CNROOFI+'&CD_CNROCORTE='+CD_CNROCORTE+'&CD_CSECUEN='+CD_CSECUEN+'&CD_CARTICULO='+CD_CARTICULO+'&CD_CTALLA='+CD_CTALLA+'&CD_CCODCOL='+CD_CCODCOL+'&CD_CCOLOR='+CD_CCOLOR+'&CD_NCANT='+CD_NCANT+'&CD_NINI='+CD_NINI+'&CD_NFIN='+CD_NFIN+'&CD_NORDEN='+CD_NORDEN+'&tabs='+_x+'&item='+i);

									$.getJSON('../corte/sqlGenCorte/GrabaCorteDet.asp?nroOFI='+CD_CNROOFI+'&CD_CNROCORTE='+CD_CNROCORTE+'&CD_CSECUEN='+CD_CSECUEN+'&CD_CARTICULO='+CD_CARTICULO+'&CD_CTALLA='+CD_CTALLA+'&CD_CCODCOL='+CD_CCODCOL+'&CD_CCOLOR='+CD_CCOLOR+'&CD_NCANT='+CD_NCANT+'&CD_NINI='+CD_NINI+'&CD_NFIN='+CD_NFIN+'&CD_NORDEN='+CD_NORDEN+'&tabs='+_x+'&item='+i,function(data){
					...
					/****************Graba Fox*****************/
				//window.open('http://192.168.3.5/webservice/GrabaCorteFox.asp?nroOFI='+nroOFI+'&estilo='+estilo+'&prenda='+prenda+'&articulo='+articulo+'&Tiempo='+Tiempo+'&numCorte='+numCorte+'&fecha='+fecha+'&cliente='+cliente+'&CPO='+CPO+'&costoEst='+costoEst+'&costoReal='+costoReal+'&codColor='+codColor+'&desColor='+desColor+'&kilos='+kilos+'&sobra='+sobra+'&tapeta='+tapeta+'&ancho='+ancho+'&largo='+largo+'&metro='+metro+'&punta='+punta+'&retazo='+retazo+'&falla='+falla+'&pepan='+pepan+'&pazpano='+pazpano+'&nropano='+nropano+'&partida='+partida+'&codTela='+codTela+'&tela='+tela+'&nropaquete='+nropaquete+'&codservicio='+codservicio+'&tpoPrenda='+tpoPrenda+'&servicio='+servicio+'&numchk='+numchk+'&tabs='+_id+'&arti1='+arti1+'&orpro='+orpro);
					//return;
					//return ;
					//$.getJSON('http://192.168.3.5/webservice/GrabaCorteFox.asp?nroOFI='+nroOFI+'&estilo='+estilo+'&prenda='+prenda+'&articulo='+articulo+'&Tiempo='+Tiempo+'&numCorte='+numCorte+'&fecha='+fecha+'&cliente='+cliente+'&CPO='+CPO+'&costoEst='+costoEst+'&costoReal='+costoReal+'&codColor='+codColor+'&desColor='+desColor+'&kilos='+kilos+'&sobra='+sobra+'&tapeta='+tapeta+'&ancho='+ancho+'&largo='+largo+'&metro='+metro+'&punta='+punta+'&retazo='+retazo+'&falla='+falla+'&pepan='+pepan+'&pazpano='+pazpano+'&nropano='+nropano+'&partida='+partida+'&codTela='+codTela+'&tela='+tela+'&nropaquete='+nropaquete+'&codservicio='+codservicio+'&tpoPrenda='+tpoPrenda+'&servicio='+servicio+'&numchk='+numchk+'&tabs='+_id+'&arti1='+arti1+'&orpro='+orpro,function(data){
					$.getJSON('http://192.168.3.5/webservice/GrabaCorteFox.asp?nroOFI='+nroOFI+'&estilo='+estilo+'&prenda='+prenda+'&articulo='+articulo+'&Tiempo='+Tiempo+'&numCorte='+numCorte+'&fecha='+fecha+'&cliente='+cliente+'&CPO='+CPO+'&costoEst='+costoEst+'&costoReal='+costoReal+'&codColor='+codColor+'&desColor='+desColor+'&kilos='+kilos+'&sobra='+sobra+'&tapeta='+tapeta+'&ancho='+ancho+'&largo='+largo+'&metro='+metro+'&punta='+punta+'&retazo='+retazo+'&falla='+falla+'&pepan='+pepan+'&pazpano='+pazpano+'&nropano='+nropano+'&partida='+partida+'&codTela='+codTela+'&tela='+tela+'&nropaquete='+nropaquete+'&codservicio='+codservicio+'&tpoPrenda='+tpoPrenda+'&servicio='+servicio+'&numchk='+numchk+'&tabs='+_id+'&arti1='+arti1+'&orpro='+orpro,function(data){
	...
	//window.open('http://192.168.3.5/webservice/GrabaCorteDetFox.asp?CD_CNROOFI='+CD_CNROOFI+'&CD_CNROCORTE='+CD_CNROCORTE+'&fecha='+fecha+'&CD_CSECUEN='+CD_CSECUEN+'&CD_CARTICULO='+CD_CARTICULO+'&CD_CTALLA='+CD_CTALLA+'&CD_CCODCOL='+CD_CCODCOL+'&CD_CCOLOR='+CD_CCOLOR+'&CD_NCANT='+CD_NCANT+'&CD_NINI='+CD_NINI+'&CD_NFIN='+CD_NFIN+'&CD_NORDEN='+CD_NORDEN+'&tabs='+_x+'&item='+i+'&ropa='+tpoPrenda+'&paqt='+nropaquete);		
									//return;			
									//$.getJSON('http://192.168.3.5/webservice/GrabaCorteDetFox.asp?CD_CNROOFI='+CD_CNROOFI+'&CD_CNROCORTE='+CD_CNROCORTE+'&CD_CSECUEN='+CD_CSECUEN+'&CD_CARTICULO='+CD_CARTICULO+'&CD_CTALLA='+CD_CTALLA+'&CD_CCODCOL='+CD_CCODCOL+'&CD_CCOLOR='+CD_CCOLOR+'&CD_NCANT='+CD_NCANT+'&CD_NINI='+CD_NINI+'&CD_NFIN='+CD_NFIN+'&CD_NORDEN='+CD_NORDEN+'&tabs='+_x+'&item='+i+'&ropa='+tpoPrenda+'&paqt='+nropaquete,function(data){
									$.getJSON('http://192.168.3.5/webservice/GrabaCorteDetFox.asp?CD_CNROOFI='+CD_CNROOFI+'&CD_CNROCORTE='+CD_CNROCORTE+'&fecha='+fecha+'&CD_CSECUEN='+CD_CSECUEN+'&CD_CARTICULO='+CD_CARTICULO+'&CD_CTALLA='+CD_CTALLA+'&CD_CCODCOL='+CD_CCODCOL+'&CD_CCOLOR='+CD_CCOLOR+'&CD_NCANT='+CD_NCANT+'&CD_NINI='+CD_NINI+'&CD_NFIN='+CD_NFIN+'&CD_NORDEN='+CD_NORDEN+'&tabs='+_x+'&item='+i+'&ropa='+tpoPrenda+'&paqt='+nropaquete,function(data){
									})
									.done(function(data)
										{
				...
				alert('Se guardó Corte Satisfactoriamente!!');
