...
'	Redim preserve Corte (y)
	...
	'						aValor = CT_CNROOFI+"|"+CT_CCODSTY+"|"+CT_CPRENDA+"|"+CT_CARTICULO+"|"+CT_NTIEMPO+"|"									+CT_CNROCORTE+"|"+CT_DFECHA+"|"+CT_CCLIENTE+"|"+CT_CPO+"|"							+CT_NCONEST+"|"+CT_NCONREA+"|"+CT_CCODCOL+"|"+CT_CDESCOL+"|"+CT_NKILOS+"|"+CT_NSOBRA+"|"+CT_NTAPETA+"|"+CT_NANCHO+"|"+CT_NLARGO+"|"+CT_NMETROS+"|"+CT_NPUNTA+"|"+CT_NRETAZOS+"|"+CT_NFALLAS+"|"+CT_NPEPAN+"|"+CT_NPZPAN+"|"+CT_NNRPAN+"|"+CT_CPARTIDA+"|"+CT_CCODTEL+"|"+																									CT_CDESTEL+"|"+CT_NPQTE+"|"+CT_NCODSER+"|"+CT_CDESSER+"|"+CT_TIPOPREN+"|"+CT_ARTI1+"|"+CT_ORPRO , '" & CT_ARTI1 & "', '" & CT_ORPRO & "' 
'	existe = false
