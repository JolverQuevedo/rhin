		...
		//if( _grb==0){
			if(confirm('¿Seguro de generar planillas y cortes?'))
			{
				...
				$("input:checkbox:checked").each(function() 
				{
					...
					/****************Graba Fox*****************/
					//window.open('http://localhost/modelador/webservice/GrabaCorteFox.asp?nroOFI='+nroOFI+'&estilo='+estilo+'&prenda='+prenda+'&articulo='+articulo+'&Tiempo='+Tiempo+'&numCorte='+numCorte+'&fecha='+fecha+'&cliente='+cliente+'&CPO='+CPO+'&costoEst='+costoEst+'&costoReal='+costoReal+'&codColor='+codColor+'&desColor='+desColor+'&kilos='+kilos+'&sobra='+sobra+'&tapeta='+tapeta+'&ancho='+ancho+'&largo='+largo+'&metro='+metro+'&punta='+punta+'&retazo='+retazo+'&falla='+falla+'&pepan='+pepan+'&pazpano='+pazpano+'&nropano='+nropano+'&partida='+partida+'&codTela='+codTela+'&tela='+tela+'&nropaquete='+nropaquete+'&codservicio='+codservicio+'&tpoPrenda='+tpoPrenda+'&servicio='+servicio+'&numchk='+numchk+'&tabs='+_id+'&arti1='+arti1+'&orpro='+orpro);
					//return;
					//return ;
					//$.getJSON('http://192.168.3.5/webservice/GrabaCorteFox.asp?nroOFI='+nroOFI+'&estilo='+estilo+'&prenda='+prenda+'&articulo='+articulo+'&Tiempo='+Tiempo+'&numCorte='+numCorte+'&fecha='+fecha+'&cliente='+cliente+'&CPO='+CPO+'&costoEst='+costoEst+'&costoReal='+costoReal+'&codColor='+codColor+'&desColor='+desColor+'&kilos='+kilos+'&sobra='+sobra+'&tapeta='+tapeta+'&ancho='+ancho+'&largo='+largo+'&metro='+metro+'&punta='+punta+'&retazo='+retazo+'&falla='+falla+'&pepan='+pepan+'&pazpano='+pazpano+'&nropano='+nropano+'&partida='+partida+'&codTela='+codTela+'&tela='+tela+'&nropaquete='+nropaquete+'&codservicio='+codservicio+'&tpoPrenda='+tpoPrenda+'&servicio='+servicio+'&numchk='+numchk+'&tabs='+_id+'&arti1='+arti1+'&orpro='+orpro,function(data){
					$.getJSON('http://localhost/modelador/webservice/GrabaCorteFox.asp?nroOFI='+nroOFI+'&estilo='+estilo+'&prenda='+prenda+'&articulo='+articulo+'&Tiempo='+Tiempo+'&numCorte='+numCorte+'&fecha='+fecha+'&cliente='+cliente+'&CPO='+CPO+'&costoEst='+costoEst+'&costoReal='+costoReal+'&codColor='+codColor+'&desColor='+desColor+'&kilos='+kilos+'&sobra='+sobra+'&tapeta='+tapeta+'&ancho='+ancho+'&largo='+largo+'&metro='+metro+'&punta='+punta+'&retazo='+retazo+'&falla='+falla+'&pepan='+pepan+'&pazpano='+pazpano+'&nropano='+nropano+'&partida='+partida+'&codTela='+codTela+'&tela='+tela+'&nropaquete='+nropaquete+'&codservicio='+codservicio+'&tpoPrenda='+tpoPrenda+'&servicio='+servicio+'&numchk='+numchk+'&tabs='+_id+'&arti1='+arti1+'&orpro='+orpro,function(data){
