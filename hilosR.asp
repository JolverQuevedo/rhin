...
var auto=0;
var url = 'HILOSR.asp?'
var alias = 'VIEW_hiloS_RHIN'
var TBL = 'RSFACCAR..AL0001ARTI'
var PK  = 'AR_CCODIGO'
var DS = 'AR_CDESCRI'
...
var olddata =''
var chk = ''
var ficha = 'fichahilosR.asp?COD='
</script>
<%' indicar el submenu desde donde es llamado
submenu = "SUBMENU.ASP?TIPO=17"
'****************************************
...
Dim TITULO
TITULO = "MAESTRO DE HILADO"
%>
<script type="text/jscript" language="jscript">
// **************************************************************
//  Indicar el nombre de la página donde se realizan los cambios 
// **************************************************************
var funcionalidad = 'comun/crea_HILOs.asp?'
function dd2(ff)
...
CAD =	" SELECT top  "&pagesize&"  " & _
        " AR_CCODIGO, AR_CDESCRI,  AR_CDESCR2, " & _
        " AR_CUNIDAD,  AR_CMONCOM   " &_
		" from "&ALIAS&"  WHERE     " & _
        " AR_CESTADO = 'V' and          "
...
<!--#include file="COMUN/COMUNmaestrosR.ASP"-->
<%  RS.Open CAD, Cnn
    SINDATOS =1
	CONT = 1
