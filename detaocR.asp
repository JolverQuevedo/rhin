...
<script type="text/jscript" language="jscript">
var funcionalidad = 'comun/INSERocR.asp?'	//  Indica el nombre de la página donde se realizan los cambios 
function dd2(ff)
...
<!--#include file="COMUN/COMUNocR.ASP"-->
...
CAD =	" SET DATEFORMAT DMY;                                                       " & _
        ...
        " from MODELADOR..VIEW_OC_RHIN WHERE                                        " & _
