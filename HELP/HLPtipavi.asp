...
'****************************************************
CAD =	" select * from tipavi where estado  = 'a'	"
...
{	var t = document.all.TABLA;
	...
	eval("window.opener.document.all.TPP"+ubi+".value=t.rows(oldrow).cells(0).innerText ")
	eval("window.opener.document.all.DTP"+ubi+".value=t.rows(oldrow).cells(1).innerText ")
	window.close()	
}
function dd2(ff)
