...
<%	Dim	ALIAS
	...
	Dim largo
		largo = 2 'longitud del código
	Dim largo2 
		largo2 = 100 ' longitud de la descripcion %>
<script>
function ACTUALIZA(cod,des)
{	window.opener.window.thisForm.TIPPRE.value = cod;
	window.opener.window.thisForm.DESTPREN.value = des;
	window.close();
}
function VERIFICA() 
