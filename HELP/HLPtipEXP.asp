...
'****************************************************
CAD =	" select * from TIPEXPLO where estado  = 'a'	"
...
{	var t = document.all.TABLA;
	...
	eval("window.opener.document.all.EXX"+ubi+".value=t.rows(oldrow).cells(0).innerText ")
	eval("window.opener.document.all.DEX"+ubi+".value=t.rows(oldrow).cells(1).innerText ")
	window.close()	
}
function dd2(ff)
