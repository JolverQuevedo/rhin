...
{	window.opener.window.thisForm.TIPTEL.value = cod;
	window.opener.window.thisForm.DESTPTEL.value = des;
	window.opener.window.thisForm.DESTPTEL.style.display = 'block';
	window.opener.window.thisForm.TIPTEL.style.display = 'block';
	window.close();
}
function REDIR(ff)
{	var t = document.all.TABLA;
...
<TABLE>
	<TR>
		<td  bgcolor="#eef1ed" width="5%"> 
			<font face="arial" size="1" color="#003399"> 
			COD</font> 
		</td>
		<td  bgcolor="#eef1ed" width="12%"> 
			<font face="arial" size="1" color="#003399"> 
			DESCRIPCION</font> 
		</td>
	</TR>
	<TR>
		<td  bgcolor="#fff0e1" width="5%"> 
			<input id =CD TYPE=TEXT MAXLENGTH=1
			style="width:100%; text-align:CENTER">
		</td>
		<td  bgcolor="#fff0e1" width="95%"> 
			<input id =DS TYPE=TEXT MAXLENGTH=100
