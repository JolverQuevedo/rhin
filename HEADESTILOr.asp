...
<tr>
	<td align= left WIDTH=35% ROWSPAN=2>
		...
		style="cursor:hand;"
		onclick="javascript: top.window.location.replace('SUBMENU.ASP?TIPO=17');">
	</td>
	<td align= CENTER>
		<font face=arial size= 3 color=DarkBlue><B>ESTILOS POR CLIENTE RHIN
		</b></font>
	</td>
...
cad =	"select * from "&TBL&" WHERE ESTADO ='A' and stat = 'R' order by "&DS&" "
rs.open cad,cnn
...
<SCRIPT>
function ENVIO()
{	cad = 'detaESTILOR.asp?pos='+trim(thisForm.CLI.value)
	//alert(cad)
