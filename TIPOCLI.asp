...
var auto=0;
var url = '../TIPOCLI.asp?pos='
var alias = '"&OWNER&".TIPOCLI'
var TBL = '"&OWNER&".tIPOCLI'
var PK  = 'tIPO'
var DS  = 'desCRIPCION'
var largo = 2
var oldrow=1
...
<tr>
	...
	<td>		
		<IMG SRC="imagenes/PRINT.gif" ALT="IMPRESION"
			onclick="javascript: window.open('REPORTES/prnTBL.asp?pk=TIPO&ds=desCRIPCION&tbl="&OWNER&".TIPOCLI&tit=TIPOS DE CLIENTES')"
			style="cursor:hand;">	
	</td>				
	<td>		
